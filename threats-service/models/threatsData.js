...
const ThreatsDataSchema = new mongoose.Schema({
    ...
    image: { type: String, required: false }, // Optional image URL related to the threat
    video: { type: String, required: false }, // Optional video URL related to the threat
    lastUpdated: { type: Date, default: Date.now }, // Timestamp for when the record was last updated
});
